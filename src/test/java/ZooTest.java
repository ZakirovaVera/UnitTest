...
import org.example.sem2.Bird;
import org.example.sem2.Mammal;
...
public class ZooTest {
    ...
    void testAnimalAges() {
        ...
        Assertions.assertEquals(5, animals.get(0).getAge());
        Assertions.assertEquals(3, animals.get(1).getAge());
        Assertions.assertEquals(10, animals.get(2).getAge());
    }
}
